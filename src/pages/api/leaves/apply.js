...
// Main Component for the Apply Leave page
export default function ApplyLeavePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        setTimeout(() => {
            router.push('/leaves'); // Redirect back to leave hub
        }, 2000);
    } catch (err) {
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                  ...
                  <select id="leaveType" name="leaveType" value={formData.leaveType} onChange={handleChange} required className="w-full mt-1 p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
