...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Always use exact server timestamp as check-in time for strict accuracy and timer synchronization
        ...
        res.status(201).json({ 
            success: true, 
            message: `Checked in from ${workLocation}.`, 
            data: populatedAttendance,
            serverTime: checkInTimestamp
        });
